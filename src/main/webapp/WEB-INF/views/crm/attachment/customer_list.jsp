...
$(function() {
	...
	$('#${entityName}_list').buildGridByJs({
		crud_listUrl : '${namespacePath}/customer/attachment/list?id=${customerid}',
	...
	<div region="north" border="false">
		<div class="datagrid-toolbar">
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					<td>
						<a href="${namespacePath}/customer/create?id=${customerid}" class="easyui-linkbutton" iconCls="icon-add" plain="true">新增</a>
						<a href="#" onclick="closeCurPage('附件')" iconCls="icon-back" class="easyui-linkbutton"  plain="true" >返回</a>
<%-- 						<a href="${namespacePath}/customer/createtest" class="easyui-linkbutton" iconCls="icon-add" plain="true">新增测试</a> --%>
					</td>
